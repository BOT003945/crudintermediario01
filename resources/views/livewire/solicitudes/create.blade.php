                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 card">
                           ...
                           <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <select class="form-control select2-hidden-accessible" wire:model="Empresa" id="Empresa1" name="Empresa1">@error('Empresa') <span class="error text-danger">{{ $message }}</span> @enderror
