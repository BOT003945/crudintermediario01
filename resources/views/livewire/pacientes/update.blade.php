                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 card">
                           ...
                           <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <input id="Paciente2" name="Paciente2" wire:model="Paciente" <?php $this->emit('newfocus'); ?> onkeypress="return soloLetras(event)" placeholder="Nombre del paciente" autocomplete="off" required class="form-control text-box single-line" type="text">@error('Paciente') <span class="error text-danger">{{ $message }}</span> @enderror
